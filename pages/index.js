                ...
                <div className="cards__item--details">  
                  ...
                  <div className="flex flex-row flex-wrap items-center justify-center my-4">
                    {rd?.socials?.map((social, i) => (
                      <a key={i} className="uppercase text-12 text-primary font-bold px-2" target="_blank" rel="noopener noreferrer" href={ social.url }>{ social.label }</a>
                    ))}
                  </div>
                </div>
                    ...
                    <div key={ i } className="cards__item--content bg-secondary p-4 mb-4">
                      ...
                      <div className="flex flex-row flex-wrap">
                        {source?.tags?.map((tag, i) => (
                          <span key={i} className="bg-accent text-white text-11 py-1 px-2 rounded-full uppercase mr-2 mt-2">{ tag }</span>
                        ))}
                      </div>
                    </div>
                  ))}
